...
const LEVELS = [
    ...
    {
        id: "easy_fun_fast",
        name: "[Easy+] Fun Fast Melody",
        fallDuration: 3.0, // fast but still easy
        tiles: [
            // Intro – simple repeating motif
            { time: 0.8, word: "la", note: "C4" },
            { time: 1.2, word: "la", note: "D4" },
            { time: 1.6, word: "la", note: "E4" },
            { time: 2.0, word: "go", note: "G4" },

            // Melodic bounce
            { time: 2.6, word: "ba", note: "E4" },
            { time: 3.0, word: "ba", note: "D4" },
            { time: 3.4, word: "ba", note: "C4" },
            { time: 3.8, word: "hey", note: "E4" },

            // Fun climb
            { time: 4.4, word: "up", note: "C4" },
            { time: 4.8, word: "up", note: "D4" },
            { time: 5.2, word: "up", note: "E4" },
            { time: 5.6, word: "pop", note: "G4" },

            // Melody 2 – catchy
            { time: 6.3, word: "ti", note: "E4" },
            { time: 6.6, word: "ti", note: "F4" },
            { time: 6.9, word: "ti", note: "G4" },
            { time: 7.2, word: "go", note: "C5" },

            // Quick cascade (feels musical but easy to type)
            { time: 7.8, word: "da", note: "A4" },
            { time: 8.1, word: "da", note: "G4" },
            { time: 8.4, word: "da", note: "E4" },
            { time: 8.7, word: "hey", note: "C4" },

            // Finale – uplifting
            { time: 9.4, word: "yo", note: "D4" },
            { time: 9.8, word: "yo", note: "E4" },
            { time: 10.2, word: "yo", note: "G4" },
            { time: 10.6, word: "go", note: "C5" },
        ],
    },
